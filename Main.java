...
public class Main {
  ...
  */
   ...
   * 1. Добавить в список объект со значениями по умолчанию (Title: title, Genre: genre, pages:
   * 100, wordPerPage: 100)
   ...
   * полностью корректно. Например, при неправильном вводе количества страниц программа
   * снова будет запрашивать данные, до тех пор пока не будут ввдены корректные данные
   * 
   */
